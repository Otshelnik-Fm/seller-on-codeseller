...
<div class="soc-blk-ava">
    <a class="soc-blk-ava-a no_marked_icon cwb_no_animate" rel="nofollow noindex noopener" target="_blank" title="Перейти" href="<?php echo $url; ?>">
		...
		<?php } else { ?>
            <img class="soc-blk-ava-img" loading="lazy" alt="Дополнение для WordPress плагина WP-Recall" src="<?php echo $pict . '?ver=' . $version . ''; ?>" width="110" height="128">
		<?php } ?>
    </a>
</div>
...
<div class="soc_tl_content">
    <div class="soc_tl_title">
        <div class="soc_tl_product_name">
            <a class="soc-title no_marked_icon cwb_no_animate" rel="nofollow noindex noopener" target="_blank" title="Перейти к описанию дополнения" href="<?php echo $url; ?>">
				<?php echo $name; ?>
            </a>
            <span title="Обновление от <?php echo $update; ?>">v.<?php echo $version; ?></span>
        </div>
        <div class="product_tl_price" title="<?php echo ( $out_sale ) ? 'Товар больше не распространяется' : 'Стоимость'; ?>"><?php echo $price; ?></div>
    </div>
