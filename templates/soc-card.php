...
<div class="soc-blk-ava">
    <a class="soc-blk-ava-a no_marked_icon cwb_no_animate" rel="nofollow noopener noindex" target="_blank" href="<?php echo $url; ?>">
		...
		<?php } else { ?>
            <img class="soc-blk-ava-img" loading="lazy" alt="Дополнение для WordPress плагина WP-Recall" src="<?php echo $pict . '?ver=' . $version . ''; ?>" width="140" height="140">
		<?php } ?>
