...
Вписывать ваш id с сервиса CodeSeller. 
<strong>Как получить id?</strong>

1. Заходим на кодеселлер
2. Выбираем товар что участвует в партнерской программе
...
Или его можно вписать в виджет Текст и расположить в сайдбаре)

<code>[codeseller_product]</code> - шорткод для вывода товаров.
...
<strong>number</strong> - предельное количество дополнений в удаленном запросе (по умолчанию 21 на страницу для страницы репозитория)
...
Дополнение, на основе сформированного шорткода, раз в час обращается к api сервиса codeseller. И кеширует данные на час.
