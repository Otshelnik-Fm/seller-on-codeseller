...
<strong>hide_outsale</strong> - ставьте значение 0, если нужно отобразить товары снятые с распространения. Их заголовок будет перечеркнут и вместо цены надпись "Снят с продажи"
...
<code>[codeseller_product template="full-width" slug="freelance-nextgen"]</code>
...
<code>[codeseller_product template="card" slug="freelance-nextgen,user-info-tab,partners-system,users-market,invest-system" random="1" limit="2"]</code>
...
Добавлен сверху общий подсчет дополнений в фильтре если их больше 5-ти
...
* При возникновении проблемы, создайте соответствующую тему на <a href="https://codeseller.ru/forum/product-13291/" target="_blank">форуме поддержки товара</a>
